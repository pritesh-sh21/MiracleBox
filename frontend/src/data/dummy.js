...
export const gridSessionButton = (props) => (
  <button
    type="button"
    style={{ background: "#e06ca0" }}
    className="text-white py-1 px-2 capitalize rounded-2xl text-md"
  >
    {props.Details}
  </button>
...
const areaChartData = [
  ...
  [
    { x: new Date(2002, 0, 1), y: 0.8 },
    { x: new Date(2003, 0, 1), y: 1.1 },
    { x: new Date(2004, 0, 1), y: 0.7 },
    { x: new Date(2005, 0, 1), y: 0.5 },
    { x: new Date(2006, 0, 1), y: 1.9 },
    { x: new Date(2007, 0, 1), y: 2.5 },
    { x: new Date(2008, 0, 1), y: 1.6 },
    { x: new Date(2009, 0, 1), y: 0.9 },
...
export const lineChartData = [
  ...
  [
    { x: new Date(2005, 0, 1), y: 5 },
    { x: new Date(2006, 0, 1), y: 8 },
    { x: new Date(2007, 0, 1), y: 12 },
    { x: new Date(2008, 0, 1), y: 22 },
...
export const PyramidData = [
  { x: "Health ", y: 120, text: "120 cal" },
  { x: "Finance", y: 435, text: "435 cal" },
  { x: "Education", y: 470, text: "470 cal" },
  { x: "Fundamental Rights", y: 475, text: "475 cal" },
  { x: "Employeement", y: 520, text: "520 cal" },
  { x: "Startups", y: 930, text: "930 cal" },
];
